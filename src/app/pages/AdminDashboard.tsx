    ...
    <div className="flex min-h-screen flex-col bg-background md:flex-row">
      ...
      <main className="min-w-0 flex-1 overflow-x-hidden p-4 md:p-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground sm:text-4xl">Админ самбар</h1>
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {adminAreas.map((area) => (
            <Card key={area.title} className="p-6">
              ...
              <h2 className="mt-5 text-xl font-semibold text-foreground">{area.title}</h2>
              <p className="mt-2 min-h-16 text-sm leading-6 text-muted-foreground">{area.text}</p>
