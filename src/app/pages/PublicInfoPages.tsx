...
const terms = [
  ...
  { title: 'Хэрэглэгчийн үүрэг', text: 'Чиглэл, авах болон буулгах цэг, суудал, үнэ, төлбөрийн нотолгоо, профайл мэдээллээ үнэн зөв оруулах шаардлагатай.' },
  { title: 'Маргаан шийдвэрлэх', text: 'Төлбөрийн баримт, аяллын төлөв, мессежийн тэмдэглэл, админы шалгалтын мэдээлэл дээр үндэслэн маргааныг ангилж шийдвэрлэнэ.' },
];

const privacy = [
  { title: 'Цуглуулах мэдээлэл', text: 'Бүртгэл, утас, хэрэглэгчийн төрөл, чиглэл, захиалга, баримт, үнэлгээ зэрэг үйлчилгээ үзүүлэхэд хэрэгтэй мэдээллийг хадгална.' },
  { title: 'Ашиглах зорилго', text: 'Хэрэглэгч тааруулах, аюулгүй байдлыг шалгах, төлбөрийн баримт баталгаажуулах, дэмжлэг үзүүлэхэд ашиглана.' },
  { title: 'Хандалтын зарчим', text: 'Хэрэглэгч бүр зөвхөн өөрт хамаарах самбар, захиалга, баримтын мэдээлэлд хандах ёстой.' },
];
