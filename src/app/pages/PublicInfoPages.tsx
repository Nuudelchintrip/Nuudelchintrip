...
export function FaqPage() {
  const faqs = [
    ...
    ['Үйлчилгээний шимтгэл хэрхэн тооцогдох вэ?', 'Жолооч, аялагчийн тохиролцсон үндсэн үнийн дүн дээр 10%-ийн үйлчилгээний шимтгэл нэмэгдэнэ. Төлбөр хийхээс өмнө үндсэн үнэ, шимтгэл, нийт төлөх дүн тус тусдаа харагдана.'],
...
const terms = [
  ...
  { title: 'Төлбөр ба үйлчилгээний шимтгэл', text: 'Жолооч, аялагчийн тохиролцсон үндсэн үнийн дүн дээр 10%-ийн үйлчилгээний шимтгэл тооцно. Аялагч төлбөрөө заасан сувгаар шилжүүлж, баримтаа оруулна. Админ төлбөрийн баримтыг баталгаажуулсны дараа захиалга баталгаажсан төлөвт шилжинэ.' },
