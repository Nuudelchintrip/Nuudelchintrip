...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', fullWidth = false, className = '', children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary text-primary-foreground shadow-sm shadow-primary/20 hover:bg-primary/90 hover:shadow-md hover:shadow-primary/25 dark:shadow-[0_1px_0_rgba(255,255,255,0.12)_inset,0_8px_22px_-14px_rgba(214,162,74,0.65)] dark:hover:brightness-105',
      ...
      outline: 'border border-border bg-card text-foreground hover:bg-secondary hover:border-primary/40 dark:hover:border-[#454545]',
